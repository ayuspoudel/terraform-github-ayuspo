locals {
  developed_applications_repositories = {
    dotmanz = {
      name        = "dotmanz"
      description = "A modular ZSH dotfiles framework and CLI toolkit that turns your terminal setup into a clean, maintainable, and self-documenting environment."
      visibility  = "public"
      archived    = false
